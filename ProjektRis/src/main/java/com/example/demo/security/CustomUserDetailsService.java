...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public CustomUserDetailsService(RegistriranUporabnikRepository registriranUporabnikRepository) {
        this.registriranUporabnikRepository = registriranUporabnikRepository;
    }

    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        RegistriranUporabnik user = registriranUporabnikRepository.findByEmail(email);
